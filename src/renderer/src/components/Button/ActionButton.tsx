...
export const ActionButton = ({ className, children, title, ...props }: ActionButtonProps) => {
  return (
    <>
      <button
        className={twMerge(
          'px-2 py-1 mr-1 rounded-md border border-zinc-400/50 hover:bg-zinc-600/50 transition-colors duration-100 relative group', // Ensure group and relative are present
          className
        )}
        {...props}
      >
