...
def fetch_popular_models(limit: int = 7) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        return [
            {"id": "mistralai/Mistral-7B-v0.1", "name": "Mistral 7B v0.1", "requires_tensorlink": True},
            {"id": "starling-lm/Starling-LM-11B-alpha", "name": "Starling LM 11B", "requires_tensorlink": True},
